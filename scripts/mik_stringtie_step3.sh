...
do
	bam=/mnt/f/genomics/scen_rnaseq/mikado_alignments/${SAMPLE}_sorted.bam
	$stringtie -eB \
	-p 12 \
	-G /mnt/f/genomics/scen_rnaseq/mikado.loci.gtf \
	-m 150 \
	-c 5 \
	-o /mnt/f/genomics/scen_rnaseq/mik_ballgown/$SAMPLE/${SAMPLE}_step3.gtf \
	$bam
done
